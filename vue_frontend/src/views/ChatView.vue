                    ...
                    >
                        <div class="flex items-center space-x-2">
                            <template
                                ...
                                v-bind:key="user.id"
                            >
                                <img :alt="user.get_avatar" :src="user.get_avatar" class="w-[40px] rounded-full">
                ...
                <div class="flex flex-col flex-grow p-4">
                    <template v-if="activeConversation">
                        ...
                        <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-300">
                            <img :src="message.created_by.get_avatar" :alt="message.created_by.get_avatar" class="w-[40px] rounded-full">
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        getMessages() {
            console.log('getMessages',!this.isObjectEmpty(this.activeConversation))
            if(!this.isObjectEmpty(this.activeConversation)){
                axios
